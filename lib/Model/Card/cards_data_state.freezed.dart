...
mixin _$CardsDataState {
  List<Map<String, dynamic>> get cards => throw _privateConstructorUsedError;
  List<String> get todaysReviewNoteRefs => throw _privateConstructorUsedError;
  List<Map<String, dynamic>> get usersMultipleCards =>
      throw _privateConstructorUsedError;
  List<Map<String, dynamic>> get notesByNoteRef =>
      throw _privateConstructorUsedError;
  List<Map<String, dynamic>> get allNotes => throw _privateConstructorUsedError;
  Map<dynamic, int> get leftValueDistribution =>
      throw _privateConstructorUsedError;
  List<Map<String, dynamic>> get allLearnedCards =>
      throw _privateConstructorUsedError;
  int get newCardCount => throw _privateConstructorUsedError;
  int get learningCardCount => throw _privateConstructorUsedError;
...
/// @nodoc
class _$CardsDataStateCopyWithImpl<$Res, $Val extends CardsDataState>
    implements $CardsDataStateCopyWith<$Res> {
  _$CardsDataStateCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    Object? cards = null,
    Object? todaysReviewNoteRefs = null,
    Object? usersMultipleCards = null,
    Object? notesByNoteRef = null,
    Object? allNotes = null,
    Object? leftValueDistribution = null,
    Object? allLearnedCards = null,
    Object? newCardCount = null,
    Object? learningCardCount = null,
...
class _$CardsDataStateImpl implements _CardsDataState {
  ...
  final List<String> _todaysReviewNoteRefs;
  @override
  @JsonKey()
  ...
  final List<Map<String, dynamic>> _usersMultipleCards;
  @override
  @JsonKey()
  List<Map<String, dynamic>> get usersMultipleCards {
  ...
  final List<Map<String, dynamic>> _notesByNoteRef;
  @override
  @JsonKey()
  List<Map<String, dynamic>> get notesByNoteRef {
  ...
  final Map<dynamic, int> _leftValueDistribution;
  @override
  @JsonKey()
  Map<dynamic, int> get leftValueDistribution {
  ...
  final List<Map<String, dynamic>> _allLearnedCards;
  @override
  @JsonKey()
  List<Map<String, dynamic>> get allLearnedCards {
  ...
  @override
  String toString() {
    return 'CardsDataState(cards: $cards, todaysReviewNoteRefs: $todaysReviewNoteRefs, usersMultipleCards: $usersMultipleCards, notesByNoteRef: $notesByNoteRef, allNotes: $allNotes, leftValueDistribution: $leftValueDistribution, allLearnedCards: $allLearnedCards, newCardCount: $newCardCount, learningCardCount: $learningCardCount, reviewCardCount: $reviewCardCount, totalCardCount: $totalCardCount)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.learningCardCount, learningCardCount) ||
                other.learningCardCount == learningCardCount) &&
            (identical(other.reviewCardCount, reviewCardCount) ||
                other.reviewCardCount == reviewCardCount) &&
            (identical(other.totalCardCount, totalCardCount) ||
                other.totalCardCount == totalCardCount));
  }
...
abstract class _CardsDataState implements CardsDataState {
  ...
  List<Map<String, dynamic>> get allLearnedCards;
  @override
  int get newCardCount;
  @override
  int get learningCardCount;
  @override
