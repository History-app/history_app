...
class AppColors with _$AppColors {
  const factory AppColors({
    ...
    @Default(Color(0xFF374142)) Color black,
    ...
    @Default(Color(0xFFF87951)) Color accent,
    @Default(Color(0xFF32ADE6)) Color skyBlue,
    @Default(Color(0xFFDBDBDB)) Color outlineColor,
