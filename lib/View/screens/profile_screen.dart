...
class ProfileScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLinkedEmail = user.isLinkedEmail();
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: CommonAppBar(title: Strings.myPageTitle),
      body: Container(
        color: Colors.white,
          ...
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(
                horizontal: horizontalPaddingNormal,
                vertical: 16,
              ),
              child: Column(
                // Centerを削除
                ...
                children: <Widget>[
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(40),
                                child: Image.asset('assets/Frame 18.png'),
                              ),
                            ),
                            Container(
                          ...
                          child: Row(
                            children: [
                              SizedBox(
                                width: 40,
                                height: 40,
                                child: Icon(Icons.delete_forever, size: 30, color: Colors.grey),
                              ),
                              Gap(12),
                          ...
                          child: Row(
                            children: [
                              SizedBox(
                                width: 40,
                                height: 40,
                                child: Icon(Icons.logout, color: Colors.grey, size: 30),
                              ),
                              Gap(12),
                              Text(Strings.logout),
                            ],
                        ...
                        child: Row(
                          children: [
                            SizedBox(
                              width: 40,
                              height: 40,
                              child: Icon(Icons.chat_bubble_outline, color: Colors.grey, size: 30),
                            ),
                            Gap(12),
                            Text(Strings.contactForm),
                          ],
                        ),
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        final Uri url = Uri.parse(
                          'https://www.notion.so/1d3bfeefad1a80dda3b3dbe4d229bd75',
                        ); // プライバシーポリシーのURLを設定
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  Strings.loginSignupMessage,
                  textScaleFactor: MediaQuery.textScaleFactorOf(context).clamp(1.0, 1.2).toDouble(),
            ...
            verticalSpaceSmall,
            Text(
              Strings.accessibleFromAnyDevice,
            ...
            Row(
              ...
              children: [
                SizedBox(
                  ...
                  child: CustomPrimaryButton(
                    ...
                    textWidget: const Text(
                      Strings.registerNewAccountLabel,
                ...
                SizedBox(
                  ...
                  child: CustomPrimaryButton(
                    onPressed: () {
                      needDeleteGuestAccount(context, ref);
                    },
                    backgroundColor: Colors.white,
