...
/// テキスト選択時のポインターの色が変更されないため使用
/// https://github.com/flutter/flutter/issues/74890#issuecomment-1874304044
class CustomColorSelectionHandle extends TextSelectionControls {
  ...
  Widget buildHandle(
    ...
    (BuildContext context) => _controls.buildHandle(context, type, textLineHeight, onTap),
  );
