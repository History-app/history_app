...
class AppColor {
  ...
  static Color getSkinTurnColor(int skinId) {
    if (skinId == 0 || skinId == 1 || skinId == 2 || skinId == 3 || skinId == 6 || skinId == 7) {
  ...
  static Color getSkinSnsColor(int skinId) {
    if (skinId == 0 || skinId == 1 || skinId == 2 || skinId == 3 || skinId == 6 || skinId == 7) {
  ...
  static Color getSkinOverlay(int skinId) {
    if (skinId == 0 || skinId == 1 || skinId == 2 || skinId == 3) {
      return Colors.transparent;
    } else if (skinId == 6 || skinId == 7) {
  ...
  static String getLogoImage(int skinId) {
    if (skinId == 0 || skinId == 1 || skinId == 2 || skinId == 3 || skinId == 6 || skinId == 7) {
      return "assets/svgs/Launch/logo-default.svg";
    } else {
      return "assets/svgs/Launch/logo-white.svg";
    }
  }
  ...
  static const MaterialColor premium = MaterialColor(0xFFA74CFF, {
    100: Color(0xFFEAD9FF),
    200: Color(0xFFC79EFF),
    300: Color(0xFFA064FF),
    400: Color(0xFF7A2EFF),
  });
  ...
  static const Color biz = Color(0xFFFF7616);
  static const Color premiumBackground = Color(0xFFF7FDFF);
}
